...
static func register()->Command:
    return new().set_name("bind").add_param("option", TYPE_STRING, true).add_param("key", TYPE_STRING, true).add_param("command", TYPE_STRING, true).set_description("Binds a command to a preferred key.")
